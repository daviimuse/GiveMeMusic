...
<?php
    ...
    $redirectUri = 'https://localhost/GiveMeMusic/user.php'; 
...
<div class="sidebar">
    ...
    <section class="home-section">
        <div class="text" style="height: 100%; width: 100%; display: flex; position: fixed; align-items: center; justify-content: center;">!User Logged!
        </div>
    </section>
                ...
                <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
                    <form action="/GiveMeMusic/API/user.php" class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input m-b-20" data-validate="Enter your email">
                            <input class="input100" type="email" id="lMail" name="lMail" placeholder="Email" required>
                            <span class="focus-input100"></span>
                        </div>
                        <div class="wrap-input100 validate-input m-b-25" data-validate = "Enter password">
                            <input class="input100" type="password" id="lPsw" name="lPsw" placeholder="Password" required>
                            <span class="focus-input100"></span>
                        </div>
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
				<form class="login100-form validate-form" method="PUT">
					...
					<div class="wrap-input100 validate-input m-b-20" data-validate="Enter your username">
						<input class="input100" type="text" id="rUsrn" name="rUsrn" placeholder="Username" required>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-20" data-validate="Enter your email">
						<input class="input100" type="text" id="rMail" name="rMail" placeholder="Email" required>
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-25" data-validate = "Enter password">
						<input class="input100" type="password" id="rPsw" name="rPsw" placeholder="Password" required>
						<span class="focus-input100"></span>
					</div>

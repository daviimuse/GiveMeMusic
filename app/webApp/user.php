...
<html lang="en">
  <head>
    ...
    <div class="text">User info<br>
        <br>
            <h6 class="text">Username: </h6><br>
            <h6 class="text">E-mail: </h6><br>
        <br>
    <a href="../newPsw.php" class="txt2 hov1" style="position: absolute; bottom: 0; left: 0;">Change password!</a>
    </section>
